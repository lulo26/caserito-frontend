...
const Productos = () => {
  const [response, setResponse] = useState([])
    ...
    return (
      <>
      <button onClick={mostrarProductos} className="rounded-xl bg-brand-500 px-5 py-3 text-base font-medium text-white transition duration-200 hover:bg-brand-600 active:bg-brand-700 dark:bg-brand-400 dark:text-white dark:hover:bg-brand-300 dark:active:bg-brand-200">
            mostrar
        </button>

...
const Sidebar = ({ open, onClose }) => {
  return (
    <div
      className={`sm:none duration-175 linear fixed !z-50 flex min-h-full flex-col bg-pink-50 pb-10 shadow-2xl shadow-white/5 transition-all dark:!bg-pink-800 dark:text-white md:!z-50 lg:!z-50 xl:!z-0 ${
